...
class Settings(BaseSettings):
    ...
    google_sheets_credentials_file: str = os.getenv(
        "GOOGLE_SHEETS_CREDENTIALS_FILE", "credentials/google_sheets_creds.json"
    )
    google_sheet_id: str = os.getenv(
        "GOOGLE_SHEET_ID", "1QZM-5VXhXCpFM6LKlNbtzo7kiX-p4WX9uPfXJt9xAkQ"
    )
...
""",
    ...
    # Application
    processing_interval: int = int(
        os.getenv("PROCESSING_INTERVAL", "300")
    )  # Seconds between fetch/send cycles
