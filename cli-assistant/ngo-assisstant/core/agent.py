...
Provide a helpful, professional response."""
    ...
    def _show_status(self):
        ...
        components = [
            ...
            ("Knowledge Base", "✅ Ready" if self.knowledge_service.vector_store else "❌ Disabled"),
            ("Email Service", "✅ Ready" if self.config.get('email') else "❌ Not configured"),
        ]
